...
let TasksController = class TasksController {
    ...
    deleteOneTask(id, user) {
        return this.taskService.deleteOneTask(id, user);
    }
    updateOneTask(id, updateTaskStatusDto, user) {
        const { status } = updateTaskStatusDto;
        return this.taskService.updateOneTask(id, status, user);
    }
};
__decorate([
    (0, common_1.Get)(),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, user_entity_1.User]),
    __metadata("design:returntype", Promise)
], TasksController.prototype, "deleteOneTask", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, update_task_status_dto_1.UpdateTaskStatusDto,
        user_entity_1.User]),
    __metadata("design:returntype", Promise)
], TasksController.prototype, "updateOneTask", null);
